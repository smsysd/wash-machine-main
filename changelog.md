#### 0.9.16
Исправлен неверный расчет бонусов
#### 0.9.14
Исправлено не срабатывание отдельных реле - реле теперь включаются в форсированном режиме.
#### 0.9.11
Убран обработчик сигнала SIGINT, вместо этого мягкое завершение программы теперь производится с помощью ipc сокета, командой 'e', \ 
вернет 0, если успешно, -1, если невозможно сейчас завершить программу.
#### 0.9.8
